...
model_path = '/data/huboxiang/metaphor/Hbb_Factory/saves/vicuna-7b-v1.5/full/sft-CL-VUAverb_train'
...
model_output_path = test_data_path.replace('.json','_CL-VUAverb_train_vicuna-7b-v1.5-0.json').replace('./test_data/','./model_output/')
try:
